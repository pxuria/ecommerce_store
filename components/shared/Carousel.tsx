  ...
  return (
    ...
    >
      ...
      >
        {side === "right" && (
          <CarouselBtn onClick={handleNext}>
            <IoCaretBack className="text-black select-none w-5 h-5 absolute top-1/2 right-1/2 translate-x-1/2 -translate-y-1/2" />
          </CarouselBtn>
        )}
        ...
        {side === "left" && (
          <CarouselBtn onClick={handlePrev}>
            <IoCaretForward className="text-black select-none w-5 h-5 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2" />
          </CarouselBtn>
        )}
      </div>
    </section>
