          ...
          <div className="flex_center gap-8">
            ...
            <div className="flex items-center gap-4 justify-end mt-auto">
              ...
              <div
                className="w-16 aspect-square"
                dangerouslySetInnerHTML={{
                  __html: `<img referrerpolicy='origin' id = 'rgvjsizpapfuoeukjxlzesgt' style = 'cursor:pointer' onclick = 'window.open("https://logo.samandehi.ir/Verify.aspx?id=395810&p=xlaopfvldshwmcsirfthobpd", "Popup","toolbar=no, scrollbars=no, location=no, statusbar=no, menubar=no, resizable=0, width=450, height=630, top=30")' alt = 'logo-samandehi' src = 'https://logo.samandehi.ir/logo.aspx?id=395810&p=qftibsiyujynaqgwnbpdlyma' />`,
                }}
              />
              ...
              <Image
                ...
                height={118}
                unoptimized
                style={{ cursor: "pointer", width: "70px", height: "118px" }}
                onClick={() =>
                  window.open(
