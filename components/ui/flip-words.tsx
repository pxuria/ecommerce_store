...
export const FlipWords = ({
  ...
  duration?: number;
  className?: string;
  autoplay?: boolean; // New autoplay prop
}) => {
  ...
  }, [isAnimating, duration, startAnimation, autoplay]);
  ...
  return (
    ...
    >
      <motion.div
        ...
        className={cn(
          "z-10 inline-block relative text-right text-[#04080D] dark:text-neutral-100 px-2",
          className
        )}
        key={currentWord}
      >
