...
export const metadata: Metadata = {
  title: "خرید انواع پارچه با بهترین قیمت | فروشگاه ارشیان بافت (ArshianBaft)",
  description:
    "فروشگاه اینترنتی ارشیان بافت ارائه‌دهنده انواع پارچه مجلسی، نخی، کتانی، مخمل، ساتن و اسپرت با کیفیت بالا و قیمت مناسب. ارسال سریع به سراسر کشور.",
  keywords: [
    "ارشیان بافت",
    "ArshianBaft",
    "فروشگاه پارچه",
